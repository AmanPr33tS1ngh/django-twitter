...
const ImageUploader = ({ onClose, onImageUpload, isImageUpload }) => {
  ...
  return (
    <div className={`relative`}>
      ...
      <div className="modal-content p-4 max-w-sm bg-white rounded-lg shadow-md">
        {isImageUpload ? <div className="file is-boxed is-centered mb-4">
        ...
        {isImageUpload ? <button className="button bg-blue-500 text-white px-4 py-2 rounded-lg" onClick={handleUploadImage}>
          Upload
        </button>:null}
      </div>
      {/*<button*/}
